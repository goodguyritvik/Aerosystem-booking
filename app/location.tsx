...
const LocationScreen = () => {
  ...
  const handleUseCurrentLocation = async () => {
    try {
      ...
      // Additional error handling for release build
      if (__DEV__ === false) {
        // Log error to remote logging service or show user-friendly message
  ...
  if (selectedLocation && addressName) {
    ...
    Alert.alert('Validation', 'Please select a location and provide a name for this address');
  }
};
